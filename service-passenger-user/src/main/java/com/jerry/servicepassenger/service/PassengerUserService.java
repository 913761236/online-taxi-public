package com.jerry.servicepassenger.service;
...
import com.jerry.servicepassenger.mapper.PassengerUserMapper;
...
public class PassengerUserService {
    ...
    public JsonRespWrapper loginOrRegister(String passengerPhone) {
        ...
        if (!isUserExist(passengerPhone)) {
            ...
            passengerUser.setPassengerName(UUID.randomUUID().toString());
            passengerUser.setPassengerGender((byte)0);
            passengerUser.setPassengerPhone(passengerPhone);
            passengerUser.setState((byte)0);
            passengerUser.setProfilePhoto("默认头像");
